...
let popupInputNameElement = popupElement.querySelector('.popup__input_name');
let popupInputJobElement = popupElement.querySelector('.popup__input_job');
let formElement = popupElement.querySelector('.popup__input_block');
